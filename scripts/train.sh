# state based
CUDA_VISIBLE_DEVICES=0 ./isaaclab.sh -p source/standalone/workflows/rsl_rl/train_rp.py --task XArm-Residual-Cube-State-v2 --max_iterations 2000 --num_envs 2048 --run_name deployable_state_0.3s_hist --headless
