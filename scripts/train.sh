# state based
# ./isaaclab.sh -p source/standalone/workflows/rsl_rl/train_rp.py --task XArm-Residual-Cube-State-v2 --max_iterations 2000 --num_envs 2048 --run_name test_state_based_deployable_fixed_termination --headless
