# state based
./isaaclab.sh -p source/standalone/workflows/rsl_rl/train_rp.py --task XArm-Residual-Cube-State-v2 --max_iterations 1000 --num_envs 1 --run_name deployable_state_new_normalized --headless
