...
### INSERTION ###
# teacher
./isaaclab.sh -p source/standalone/workflows/rsl_rl/play_rp.py --task XArm-Residual-Insertion-Teacher --enable_cameras --num_envs 9 --load_run 2025-05-11_02-31-12_insertion_keypoint_dmr_aug
