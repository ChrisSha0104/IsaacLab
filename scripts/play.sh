...
### INSERTION ###
# teacher
./isaaclab.sh -p source/standalone/workflows/rsl_rl/play_rp.py --task XArm-Residual-Insertion-Teacher --enable_cameras --num_envs 4 --load_run 2025-05-11_00-04-58_insertion_all_together_small_dmr
