...
./isaaclab.sh -p source/standalone/workflows/rsl_rl/play_rp.py --task XArm-Residual-Cube-State-v2 --num_envs 1 --load_run 2025-04-15_22-14-41_deployable_state_no_scaling --checkpoint model_500
