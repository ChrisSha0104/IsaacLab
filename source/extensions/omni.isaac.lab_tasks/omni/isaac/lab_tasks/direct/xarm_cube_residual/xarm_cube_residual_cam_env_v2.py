...
class XArmCubeResidualCamLocalBinaryNewEnv(DirectRLEnv):
    ...
    def __init__(self, cfg: XArmCubeResidualCamLocalBinaryNewEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        self.teleop_comm_obs = torch.zeros((self.num_envs, 8), device=self.device)
    ...
    def _reset_idx(self, env_ids):
        ...
        self.demo_wp_obs[env_ids,:8] = self.training_demo_traj[env_ids,:8, self.demo_idx[:, env_ids]] #+ self.init_ee[env_ids,:8]
        import pdb; pdb.set_trace()
