...
@configclass
class XArmCubeResidualCamLocalEnvCfg(DirectRLEnvCfg):
    # env 
...
class XArmCubeResidualCamLocalEnv(DirectRLEnv):
    ...
    cfg: XArmCubeResidualCamLocalEnvCfg

    def __init__(self, cfg: XArmCubeResidualCamLocalEnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def _pre_physics_step(self, ee_residual: torch.Tensor):
        ...
        self.joint_pos = self.get_joint_pos_from_ee_pos(self.diff_ik_controller, ee_goal_filtered) # ee_goal always abs coordinates
