...
class XArmGearResidualCamLocalBinaryV0Env(DirectRLEnv):
    ...
    cfg: XArmGearResidualCamLocalBinaryV0EnvCfg

    def __init__(self, cfg: XArmGearResidualCamLocalBinaryV0EnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def _setup_scene(self):
        ...
        self._fixed_asset = Articulation(self.cfg.fixed_asset)
        self._held_asset = Articulation(self.cfg.held_asset)
        self._small_gear_asset = Articulation(self.cfg.small_gear_cfg)
        self._large_gear_asset = Articulation(self.cfg.large_gear_cfg)
    ...
    def _compute_rewards(self):
        ...
        # object_ee_distanece = torch.norm(cube_pos_b - ee_gripper_b, dim=1)
        ee_dist_reward = 0 #torch.exp(-object_ee_distance / self.cfg.ee_dist_std)
        ...
        completion = 0 #torch.where(completion_condition, 1.0, 0.0)
        ...
        self.extras["log"] = {
            "height_reward": (self.cfg.height_reward_scale * height_reward),
            "residual_penalty": (self.cfg.residual_penalty_scale * residual_penalty).mean(),
            "ee_dist_reward": (self.cfg.ee_dist_reward_scale * ee_dist_reward),
            ...
            "completion": (self.cfg.completion_scale * completion),
