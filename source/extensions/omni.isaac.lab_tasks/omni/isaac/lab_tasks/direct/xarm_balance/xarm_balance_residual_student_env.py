...
@configclass
class XArmBalanceResidualStudentEnvCfg(DirectRLEnvCfg):
    # env 
...
class XArmBalanceResidualStudentEnv(DirectRLEnv):
    ...
    cfg: XArmBalanceResidualStudentEnvCfg

    def __init__(self, cfg: XArmBalanceResidualStudentEnvCfg, render_mode: str | None = None, **kwargs):
