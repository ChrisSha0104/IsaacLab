...
@configclass
class XArmCubeResidualStudentEnvCfg(DirectRLEnvCfg):
    # env 
...
class XArmCubeResidualStudentEnv(DirectRLEnv):
    ...
    cfg: XArmCubeResidualStudentEnvCfg

    def __init__(self, cfg: XArmCubeResidualStudentEnvCfg, render_mode: str | None = None, **kwargs):
