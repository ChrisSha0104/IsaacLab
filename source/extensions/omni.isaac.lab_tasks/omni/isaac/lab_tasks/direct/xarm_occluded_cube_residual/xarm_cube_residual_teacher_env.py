...
@configclass
class XArmCubeResidualTeacherEnvCfg(DirectRLEnvCfg):
    # env 
...
class XArmCubeResidualTeacherEnv(DirectRLEnv):
    ...
    cfg: XArmCubeResidualTeacherEnvCfg

    def __init__(self, cfg: XArmCubeResidualTeacherEnvCfg, render_mode: str | None = None, **kwargs):
